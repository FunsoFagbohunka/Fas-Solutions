...
export class Services {
  services: ServiceCard[] = [
    {
      svg: `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v4"/><path d="m15.2 7.6 2.4-2.4"/><path d="M18 12h4"/><path d="m15.2 16.4 2.4 2.4"/><path d="M12 18v4"/><path d="m4.4 19.8 2.4-2.4"/><path d="M2 12h4"/><path d="m4.4 4.2 2.4 2.4"/><circle cx="12" cy="12" r="4"/></svg>`,
